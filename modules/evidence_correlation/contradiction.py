...
class ContradictionEngine:
    ...
    def find_contradictions(
        ...
        # 4. Header Identity Divergence (From vs Reply-To / Return-Path)
    ...
    def _check_auth_vs_lookalike(
        ...
        has_lookalike = any(
            ...
            or "lookalike" in e.description.lower()
            for e in m2_ev
        )
        ...
        if not has_lookalike and module2_report is not None:
            ...
            if d2.get("is_lookalike") or d2.get("candidate_score", 0.0) > 0.0:
                has_lookalike = True
    ...
    def _check_ml_vs_deterministic(
        ...
        high_sev_deterministic = [
            ...
            if e.source_module not in ("email_threat_classifier", "bec_intent_classifier", "url_risk_classifier")
            and e.severity == "high"
        ]
